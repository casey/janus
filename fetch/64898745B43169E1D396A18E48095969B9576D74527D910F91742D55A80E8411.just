...
compile compile-path='target/classes': javac
    @just _cmdprint "Compile clojure code... \n"
    clojure -M:compile -e "(require,'badigeon.compile)(badigeon.compile/compile,'org.rssys.flinkexample.core,{:compile-path,\"{{compile-path}}\"})"
